...
return [
	...
	//'frontend_url' => 'http://www.yourwebsite.com',	// For localhost: 'http://localhost/MulteCart/multefront/web',
													// dont put trailing slash
    'frontend_url' => 'http://localhost/landing_matti/multefront/web',

	//'backend_url' => 'http://backend.yourwebsite.com',	// For localhost: 'http://localhost/MulteCart/multeback/web',
    'backend_url' => 'http://localhost/landing_matti/multeback/web',
														// dont put trailing slash
	...
	'ftp_server_details' => [
        ...
        //'web_url' =>  'http://files.yourwebsite.com', // Web accessible path for "attachments" folder.
            'web_url' =>  'http://localhost/landing_matti/multeback/web/attachments',
