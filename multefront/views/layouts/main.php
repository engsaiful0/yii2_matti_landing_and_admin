...
<body class="cms-index-index cms-home-page" style="background-color: white!important; ">
<div id="page">
    <?php $this->beginBody() ?>
    ...
    <div class="container-fluid" id="logo-details">
        <div class="row" style="height: 100px ">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12" style="margin-left: 5px; margin-right: 5px;">
                ...
                <div class="row" style="height: 120px;width: 100%;margin: 0 auto "
                <div class="form-group" >
                    ...
                    <div id="myProgress" >
                        ...
                        <div id="audio-player-container">
                            <div class="audio-progress" id="audio-progress">
                                <div id="draggable-point" style="left:5%;position:absolute;" class="draggable ui-widget-content">
                                    <div id="audio-progress-handle"></div>
                                </div>
                                <div id="audio-progress-bar" class="bar" style="width:5%;background-color: red;height: 8px;">
                                </div>
                                <p id="week_show" style="text-align:center">1-4 Weeks</p>
    ...
    $('#draggable-point').draggable({
        ...
        drag: function () {
            ...
            if(xpos<=25)
            {
                ...
                document.getElementById("week_show").innerHTML = "1 week";
            ...
            }else if(xpos>=26&&xpos<=50)
            {

                document.getElementById("week_show").innerHTML ="2 weeks";
            ...
            else if(xpos>=51&&xpos<=75)
            {

                document.getElementById("week_show").innerHTML ="3 weeks";
            ...
            else if(xpos>=76&&xpos<=100)
            {
                document.getElementById("week_show").innerHTML ="4 weeks";
