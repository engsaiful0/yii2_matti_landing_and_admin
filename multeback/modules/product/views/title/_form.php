...
<div class="product-category-form">
	...
	'title_name'=>	['name'=> Form::INPUT_TEXT, 'options'=>['placeholder'=>Yii::t('app', 'Enter Title Name...'), 'maxlength'=>255]],
...
//'updated_at'=>['type'=> Form::INPUT_TEXT, 'options'=>['placeholder'=>'Enter Updated At...']], 
	...
	{
	?>
		<input type="hidden" name="Title[added_by_id]" class="form-control" value="<?=Yii::$app->user->identity->id?>">
	<?php
	}
